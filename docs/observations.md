...
- **GPM IMERG** — NASA satellite–gauge global precipitation (0.1°, monthly), shown as a long-term climatology map and an animated seasonal cycle of the tropical rain belt.
